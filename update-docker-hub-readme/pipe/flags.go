...
var Flags = []cli.Flag{
	cli.StringFlag{
		...
		EnvVar:      "DOCKER_USERNAME,PLUGIN_DOCKER_USERNAME",
		Required:    true,
	...
	cli.StringFlag{
		...
		EnvVar:      "DOCKER_PASSWORD,PLUGIN_DOCKER_PASSWORD",
		Required:    true,
	...
	cli.StringFlag{
		...
		EnvVar:      "DOCKER_HUB_ADDRESS,PLUGIN_DOCKER_HUB_ADDRESS",
	...
	cli.StringFlag{
		...
		EnvVar:      "README_REPOSITORY,PLUGIN_README_REPOSITORY",
		Required:    true,
	...
	cli.StringFlag{
		...
		EnvVar:      "README_FILE,PLUGIN_README_FILE",
		Value:       "README.md",
	...
	cli.StringFlag{
		...
		EnvVar:      "README_DESCRIPTION,PLUGIN_README_DESCRIPTION",
